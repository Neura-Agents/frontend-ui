        ...
        <Dialog open={isOpen} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-[550px] overflow-hidden">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Set up a new collection of documents for your AI to use as context.
                    </DialogDescription>
                </DialogHeader>
                ...
                <div className="space-y-6">
                    ...
                    <div className="space-y-4">
                        <div className="space-y-2">
                            <Label htmlFor="kb-name" className="text-sm font-semibold">Knowledge Base Name</Label>
                            <Input
                                id="kb-name"
                                placeholder="e.g., Technical Docs, Marketing Wiki..."
                                value={name}
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="kb-desc" className="text-sm font-semibold">Description</Label>
                            <Textarea
                                id="kb-desc"
                    ...
                    <div className="space-y-3">
                        <Label className="text-sm font-semibold">Initial Documents (Optional)</Label>
                        <div
                        ...
                        >
                            ...
                            <div>
                                ...
                                <Typography scale="sm" className="text-muted-foreground mt-1">PDF, DOCX, TXT, or Image files up to 10MB each</Typography>
                            </div>
                            <input
                                type="file"
                                ref={fileInputRef}
